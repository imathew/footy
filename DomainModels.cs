...
public record Round(int Id, string Name, string Status, DateTimeOffset Now, IReadOnlyList<Match> Matches, IReadOnlyList<int>? ByeTeamIds = null, int? PreviousRoundId = null, int? NextRoundId = null, string? PreviousRoundName = null, string? NextRoundName = null);